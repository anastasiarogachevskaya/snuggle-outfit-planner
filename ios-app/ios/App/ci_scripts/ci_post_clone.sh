...
# podspec's GoogleSignIn version. Run with bun, not node — this image only
# has bun on PATH (installed above), not a standalone Node.js.
bun scripts/patch-google-auth-plugin.mjs
