...
export const WalkIcon = (p: IconProps) => (
  <Svg {...p}>
    ...
    <path d="M13.5 9.5 16 12l3 .5" />
    <path d="M11.5 15.5 9 21" />
  </Svg>
);
...
export const CarIcon = (p: IconProps) => (
  <Svg {...p}>
    ...
    <path d="M3.5 15h17" />
    <path d="M5 15v1.5a1 1 0 0 0 1 1h1.5a1 1 0 0 0 1-1V15" />
    <path d="M15.5 15v1.5a1 1 0 0 0 1 1H18a1 1 0 0 0 1-1V15" />
