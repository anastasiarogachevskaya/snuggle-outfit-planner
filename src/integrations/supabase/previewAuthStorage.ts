...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      // `finish` closes over `timer` but only runs asynchronously (via
      // onMessage or this same timeout), by which point this const is
      // already assigned — the declaration order here is safe.
